...
import { adminRegister, adminLogin, readAdmin, updateAdmin, logout, getAllAdmins, getAllPatients } from '../controllers/adminController.js';
...
router.get(ADMIN_PATHS.read, adminAuthorization(['superadmin', 'doctor', 'nurse']), schemaValidator(adminPathBase.read), readAdmin);
console.log('Admin read path:', ADMIN_PATHS.read);
router.put(ADMIN_PATHS.update, adminAuthorization(['superadmin', 'doctor', 'nurse']), schemaValidator(adminPathBase.update), updateAdmin);
console.log('Admin update path:', ADMIN_PATHS.update);
router.post(ADMIN_PATHS.logout, logout);
console.log('Admin logout path:', ADMIN_PATHS.logout);
router.get(ADMIN_PATHS.getAllAdmins, adminAuthorization(['superadmin']), schemaValidator(adminPathBase.getAllAdmins), getAllAdmins);
console.log('Admin getAllAdmins path:', ADMIN_PATHS.getAllAdmins);
router.get(ADMIN_PATHS.getAllPatients, adminAuthorization(['superadmin', 'doctor', 'nurse']), schemaValidator(adminPathBase.getAllPatients), getAllPatients);
console.log('Admin getAllPatients path:', ADMIN_PATHS.getAllPatients);
